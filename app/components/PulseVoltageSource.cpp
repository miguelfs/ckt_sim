...
PulseVoltageSource::PulseVoltageSource(std::string row, int quantityOfArguments, int wire, double timeStep) {
...
void PulseVoltageSource::stampRightSideVector(double *rightSideVector, OperationMethod operationMethod) {
